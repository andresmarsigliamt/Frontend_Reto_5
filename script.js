...
function obtenerInformacion() {
    $.ajax({
        url: "http://152.67.49.13:8080/api/Audience/all",
        type: "GET",
        datatype: "JSON",
...
function guardarInformacion() {
    ...
    $.ajax({
        ...
        url: "http://152.67.49.13:8080/api/Audience/save",
...
function editarInformacion(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Audience/update",
        success: function(response) {
            console.log(response);
...
function borrarElemento(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Audience/delete",
        success: function(response) {
            console.log(response);
...
function obtenerInformacionCliente() {
    $.ajax({
        url: "http://152.67.49.13:8080/api/Client/all",
        type: "GET",
        datatype: "JSON",
        success: function(respuesta) {
            console.log(respuesta);
...
function guardarInformacionCliente() {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Client/save",
        success: function(response) {
            console.log(response);
            console.log("Se guardo correctamente");
            alert("Se guardo correctamente");
...
function editarInformacionCliente(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Client/update",
        success: function(response) {
            console.log(response);
            console.log("Se actualizo correctamente");
            alert("Se actualizo correctamente");
...
function borrarElementoCliente(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Client/delete",
        success: function(response) {
            console.log(response);
            console.log("Se elimino correctamente");
            alert("Se elimino correctamente");
...
function obtenerInformacionMensaje() {
    $.ajax({
        url: "http://152.67.49.13:8080/api/Message/all",
        type: "GET",
        datatype: "JSON",
        success: function(respuesta) {
            console.log(respuesta);
...
function guardarInformacionMensaje() {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Message/save",
        success: function(response) {
            console.log(response);
            console.log("Se guardo correctamente");
            alert("Se guardo correctamente");
...
function editarInformacionMensaje(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Message/update",
        success: function(response) {
            console.log(response);
            console.log("Se actualizo correctamente");
            alert("Se actualizo correctamente");
...
function borrarElementoMensaje(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Message/delete",
        success: function(response) {
            console.log(response);
            console.log("Se elimino correctamente");
            alert("Se elimino correctamente");
...
function obtenerInformacionCategoria() {
    $.ajax({
        url: "http://152.67.49.13:8080/api/Category/all",
        type: "GET",
        datatype: "JSON",
        success: function(respuesta) {
            console.log(respuesta);
...
function guardarInformacionCategoria() {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Category/save",
        success: function(response) {
            console.log(response);
            console.log("Se guardo correctamente");
            alert("Se guardo correctamente");
...
function editarInformacionCategoria(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Category/update",
        success: function(response) {
            console.log(response);
            console.log("Se actualizo correctamente");
            alert("Se actualizo correctamente");
...
function borrarElementoCategoria(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Category/delete",
        success: function(response) {
            console.log(response);
            console.log("Se elimino correctamente");
            alert("Se elimino correctamente");
...
function obtenerInformacionReservacion() {
    $.ajax({
        url: "http://152.67.49.13:8080/api/Reservation/all",
        type: "GET",
        datatype: "JSON",
        success: function(respuesta) {
            console.log(respuesta);
...
function guardarInformacionReservacion() {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Reservation/save",
        success: function(response) {
            console.log(response);
            console.log("Se guardo correctamente");
            alert("Se guardo correctamente");
...
function editarInformacionReservacion(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Reservation/update",
        success: function(response) {
            console.log(response);
            console.log("Se actualizo correctamente");
            alert("Se actualizo correctamente");
...
function borrarElementoReservacion(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Reservation/delete",
        success: function(response) {
            console.log(response);
            console.log("Se elimino correctamente");
            alert("Se elimino correctamente");
...
function obtenerInformacionAdmin() {
    $.ajax({
        url: "http://152.67.49.13:8080/api/Admin/all",
        type: "GET",
        datatype: "JSON",
        success: function(respuesta) {
            console.log(respuesta);
...
function guardarInformacionAdmin() {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Admin/save",
        success: function(response) {
            console.log(response);
            console.log("Se guardo correctamente");
            alert("Se guardo correctamente");
...
function editarInformacionAdmin(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Admin/update",
        success: function(response) {
            console.log(response);
            console.log("Se actualizo correctamente");
            alert("Se actualizo correctamente");
...
function borrarElementoAdmin(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Admin/delete",
        success: function(response) {
            console.log(response);
            console.log("Se elimino correctamente");
            alert("Se elimino correctamente");
...
function obtenerInformacionScore() {
    $.ajax({
        url: "http://152.67.49.13:8080/api/Score/all",
        type: "GET",
        datatype: "JSON",
        success: function(respuesta) {
            console.log(respuesta);
...
function guardarInformacionScore() {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Score/save",
        success: function(response) {
            console.log(response);
            console.log("Se guardo correctamente");
            alert("Se guardo correctamente");
...
function editarInformacionScore(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Score/update",
        success: function(response) {
            console.log(response);
            console.log("Se actualizo correctamente");
            alert("Se actualizo correctamente");
...
function borrarElementoScore(idElemento) {
    ...
    $.ajax({
        ...
        datatype: "JSON",
        data: JSON.stringify(myData),
        url: "http://152.67.49.13:8080/api/Score/delete",
        success: function(response) {
            console.log(response);
            console.log("Se elimino correctamente");
            alert("Se elimino correctamente");
